...
{
    [SessionAuthorize]
    public class UserController20260218 : Controller
    {
        private readonly AppDbContext _context;
        private readonly ILogger<UserController20260218> _logger;

        public UserController20260218(AppDbContext context, ILogger<UserController20260218> logger)
        {
            _context = context;
            _logger = logger;
        }
